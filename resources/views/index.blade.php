									...
									<section>
										...
										<div class="row">
											...
											<div class="col-4 col-6-medium col-12-small">
												<section class="box">
													<a href="{{route('detallePelicula',$pelicula->id)}}" class="image featured"><img src="{{$pelicula->imagen}}" alt="" /></a>
													<header>
													...
													<footer>
														<ul class="actions">
															<li><a href="{{route('detallePelicula',$pelicula->id)}}" class="button alt">Ver mas </a></li>
														</ul>
													</footer>
												</section>
											</div>
